...
export default function UserGuest() {
  ...
  return (
    <ScrollView style={stylesGuest.viewBody} centerContent={true}>
      <Image source={logo} style={stylesGuest.image} resizeMode="contain" />
      ...
      <Text style={stylesGuest.descrption}>
        ¿Como determinarias la mejor elección de compra? Busca y visualiza los
        mejores precios de tus productos de una forma sencilla, elige la mejor
        opción.
      </Text>

      <View style={stylesGuest.viewBtn}>
        <Button
          buttonStyle={stylesGuest.button}
